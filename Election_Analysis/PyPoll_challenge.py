...
with open(file_to_save, "w") as txt_file:
    ...
    txt_file = open(file_to_save, "a")

    # 6a: Write a for loop to get the county from the county dictionary.
    for county in county_votes:

        # 6b: Retrieve the county vote count.
        all_votes = county_votes[county]
        ...
        county_results = (f"{county}: {all_votes_percentage: .1f}% : ({all_votes:,})\n")
...
# Save the winning candidates's result to the text file.
txt_file = open(file_to_save, 'a')
